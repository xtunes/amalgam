...
describe Amalgam::Types::Hierachical do
  ...
  before do
    @page1 = HierachicalPage.create(:title => 'test1')
    @page2 = HierachicalPage.create(:title => 'test2')
    @page3 = HierachicalPage.create(:title => 'test3',:parent_id => @page1.id)
    @page1_seo = HierachicalseoPage.create(:title => 'test1')
    @page2_seo = HierachicalseoPage.create(:title => 'test2')
    @page3_seo = HierachicalseoPage.create(:title => 'test3',:parent_id => @page1_seo.id)
  end
